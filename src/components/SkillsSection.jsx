...
const skills = [
    ...
    {name: "TailwindCSS", level: 85, category: "Software"},
    {name: "Java", level: 80, category: "Software"},

    {name: "SolidWorks", level: 85, category: "CAD"},
    {name: "Fusion360", level: 90, category: "CAD"},
...
const categories = ["all", "CAD", "Mechanical", "Software", ];
                    ...
                    {categories.map((category, key) => (
                        <button 
                            ...
                            className={cn(
                                ...
                                activeCategory === category ? "bg-primary text-primary-foreground" : "bg-secondary/70 text-foreground hover:bg-secondary/50",
                            )}
                        >
                            {category}
                        </button>
